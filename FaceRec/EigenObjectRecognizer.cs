...
namespace Emgu.CV
{
   ...
   public class EigenObjectRecognizer
   {
      ...
      /// <param name="termCrit">The criteria for recognizer training</param>
      public EigenObjectRecognizer(Image<Gray, Byte>[] images, String[] labels, string[] v, int v1, ref MCvTermCriteria termCrit)
      ...
      public EigenObjectRecognizer(Image<Gray, Byte>[] images, String[] labels, double eigenDistanceThreshold, ref MCvTermCriteria termCrit)
      {
        ...
        public EigenObjectRecognizer(Image<Gray, byte>[] images, string[] v, ref MCvTermCriteria termCrit)
        {
            this.images = images;
            this.v = v;
